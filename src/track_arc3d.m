...
function V = track_arc3d(x,y,z,acc,scale,th1r,th1z,colorSpec1,colorSpec2,colorSpec3,colorSpec4)
P2=[x(1) y(1) z(1)];
P1=[x(2) y(2) z(2)];
...
hold on
 plot3(V1bl(1,:),V1bl(2,:),V1bl(3,:),'k')
 hold on
 plot3(V1bll(1,:),V1bll(2,:),V1bll(3,:),'k')
 hold on
...
plot3(V1bl2(1,:),V1bl2(2,:),V1bl2(3,:),'k')
hold on
plot3(V1bl3(1,:),V1bl3(2,:),V1bl3(3,:),'k')
hold on
