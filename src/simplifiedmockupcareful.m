function simplifiedmockupcareful(R,hh,H1,H2,H3,H4,K1,K2,K3,K4,theta5,alpha43,h,r5,coe1,inf45,sup45,r4,A,B,infAB,supAB,l45,k1_b)
axcern =0.02;
visibleaxes=0;
e1=[1,0,0];
e2=[0,1,0];
...
% hold on
% track_arc3d([P2(1,1) ;P1(1,1)],[P2(2,1) ;P1(2,1)],[P2(3,1) ;P1(3,1)],200,th_r,th_z,[0.5,0.5,0.5],[1,0,0])
% % plot3(V1(1,:),V1(2,:),V1(3,:),'Color' , 'k', 'LineWidth', 2)
% hold on

 V1=track_arc([P2(1,1) ;P1(1,1)],[P2(2,1) ;P1(2,1)],[P2(3,1) ;P1(3,1)],200)
plot3(V1(1,:),V1(2,:),V1(3,:),'Color' , 'k', 'LineWidth', 2)
hold on
% plotOnSphere([P1(1,1); P2(1,1)],[P1(2,1) ;P2(2,1)],[P1(3,1) ;P2(3,1)])
% hold on
V2=track_arc([P2(1,2) ;P1(1,2)],[P2(2,2) ;P1(2,2)],[P2(3,2) ;P1(3,2)],200)
plot3(V2(1,:),V2(2,:),V2(3,:),'Color' , 'k', 'LineWidth', 2)
hold on
V3=track_arc([P2(1,3) ;P1(1,3)],[P2(2,3) ;P1(2,3)],[P2(3,3) ;P1(3,3)],200)
plot3(V3(1,:),V3(2,:),V3(3,:),'Color' , 'k', 'LineWidth', 2)
hold on
V4=track_arc([P2(1,4) ;P1(1,4)],[P2(2,4) ;P1(2,4)],[P2(3,4) ;P1(3,4)],200)
plot3(V4(1,:),V4(2,:),V4(3,:),'Color' , 'k', 'LineWidth', 2)
hold on
...
V5=track_arc([P3(1,1) ;P2(1,1)],[P3(2,1) ;P2(2,1)],[P3(3,1) ;P2(3,1)],200)
plot3(V5(1,:),V5(2,:),V5(3,:),'Color' , 'k', 'LineWidth', 2)
hold on
V6=track_arc([P3(1,2) ;P2(1,2)],[P3(2,2) ;P2(2,2)],[P3(3,2) ;P2(3,2)],200)
plot3(V6(1,:),V6(2,:),V6(3,:),'Color' , 'k', 'LineWidth', 2)
hold on
V7=track_arc([P3(1,3) ;P2(1,3)],[P3(2,3) ;P2(2,3)],[P3(3,3) ;P2(3,3)],200)
plot3(V7(1,:),V7(2,:),V7(3,:),'Color' , 'k', 'LineWidth', 2)
hold on
V8=track_arc([P3(1,4) ;P2(1,4)],[P3(2,4) ;P2(2,4)],[P3(3,4) ;P2(3,4)],200)
plot3(V8(1,:),V8(2,:),V8(3,:),'Color' , 'k', 'LineWidth', 2)
hold on
